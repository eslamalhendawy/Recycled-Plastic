...
function Info() {
  return (
    <div className="container mx-auto px-6 py-12 flex flex-col gap-10 md:gap-16 md:flex-row items-center">
      ...
      <div className="flex-1">
        <span className="text-blackColor font-medium text-lg">ABOUT US</span>
        <h2 className="text-lightGreen text-3xl lg:text-5xl md:w-3/4 my-6 md:my-2 lg:my-6 font-semibold">Designed with Sustainability and Innovation</h2>
        ...
        {/* <Link to="/our-story" className="font-semibold text-[#212529] pb-1 hover:border-[#262b2c] duration-300 border-b-2 border-lightGreen">READ MORE</Link> */}
      </div>
    </div>
  );
}
