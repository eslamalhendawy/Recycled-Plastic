...
function Cart() {
  ...
  const url = "https://anotherchance-production.up.railway.app/carts/get-one";
  const removeURL = "https://anotherchance-production.up.railway.app/carts/remove-from-cart?cart_item_id=";
