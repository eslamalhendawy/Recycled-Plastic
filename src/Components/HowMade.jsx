...
function HowMade({bg}) {
  return (
    <div className={`bg-[${bg}] container mx-auto px-6 py-12`}>
      <h2 className="text-center mb-6 text-[#212529] font-semibold text-4xl">See how it&apos;s made</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 items-center">
        <div className="mb-4 md:mb-0">
          <div className="mb-4 md:mb-20">
            <span className="text-siam font-medium text-lg">01.</span>
            <h3 className="text-[#212529] text-3xl my-3">Collection</h3>
            <p className="text-xl text-[#979a9b] md:w-3/4">Plastic waste is carefully sourced from trusted recycling programs.</p>
          </div>
          <div>
            <span className="text-siam font-medium text-lg">02.</span>
            <h3 className="text-[#212529] text-3xl my-3">Sorting</h3>
        ...
        <div>
          <div className="mt-4 md:mt-0">
            <div className="mb-4 md:mb-20">
              <p className="text-siam font-medium text-lg text-end">03.</p>
              <h3 className="text-[#212529] text-3xl my-3 text-end">Transformation</h3>
            ...
            <div>
              <p className="text-siam font-medium text-lg text-end">04.</p>
              <h3 className="text-[#212529] text-3xl my-3 text-end">Creation</h3>
