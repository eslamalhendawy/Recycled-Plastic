  ...
  return (
    <div className='bg-[#f1f1ef] container mx-auto px-12 py-12 flex flex-col-reverse md:flex-row md:items-center'>
      <div className='md:basis-1/2'>
        <p className='text-[#979a9b] text-center md:text-left md:text-xl mb-16'>Every piece tells a story of transformation—turning waste into something remarkable. Together, we’re shaping a future where sustainability meets innovation.</p>
